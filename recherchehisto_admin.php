...
<body>
    ...
    <div class="md:flex m-4">
        <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-600  md:me-4 mb-4 md:mb-0">
            <li>
                <a href="interventions_admin.php" id="interventions" class="category gap-1 inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-100 hover:bg-gray-200 w-full" aria-current="page">
            ...
            <li>
                <a href="historique_admin.php" class="gap-1 inline-flex items-center px-4 py-3 text-white bg-cyan-400 hover:bg-cyan-800 active rounded-lg w-full">
            ...
            <li>
                <a href="utilisateurs_admin.php" class="category gap-1 inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-100 hover:bg-gray-200 w-full">
        ...
        <div class="flex justify-between items-center">
            <form class="w-full max-w-md mx-auto" action="recherchehisto_standardiste.php" method="post">
            ...
            <form action='intervention_managing.php' method='post' class='flex-col'>
                <input type='hidden' name='create' value='", $row["userid"],"'>
                <button type='submit' href='intervention_managing.php' class='inline-flex items-center text-white bg-cyan-400 hover:bg-cyan-800 border-0 py-1 px-3 focus:outline-none rounded text-base mt-4 md:mt-0 mx-4'>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    if($row["status"]== "Terminé" or $row["status"]== "Annulé"){
                        echo "
                            <div class='bg-cyan-300 rounded m-4 p-4'>
                                <div class='flex p-4 justify-between font-bold items-start text-medium'>
                                    ...
                                    <div class='flex gap-5 items-center'>
                                        ...
                                        <form action='State_managing.php' method='post' class='flex gap-1 item-center'>
                                            <select class='border border-gray-400 p-2 rounded w-full' name='status' id='status'>
                                                <option value='' disabled selected>",$row["status"],"</option>
                                            ...
                                            <input type='hidden' name='intervention_id' value='", $row["id"],"'>
                                            <button type='submit' class='inline-flex items-center bg-white border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 hover:text-gray-900 rounded text-base mt-4 md:mt-0 mx-4'>
                                                Changer
                                            </button>
                                        </form>
                                    </div>
                                ...
                                while($rowcom = $resultcom->fetch_assoc()) {
                                    ...
                                    $sql = "SELECT u.nom AS nom_auteur, u.prenom AS prenom_auteur
                                                    ...
                                                    <div class='flex-col p-4 items-start text-medium text-gray-500'>
                                                        <div class='flex-col gap-1'>
                                                            <h1 class='text-xl mb-1 font-bold'>
                                                                ",$rowuser["nom_auteur"]," ",$rowuser["prenom_auteur"],"
                                                            </h1>
                                                            <h2>
                                                                ",$rowcom["created_at"],"
                                                            </h2>
