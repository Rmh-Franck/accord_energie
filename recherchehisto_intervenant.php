...
<body>
    ...
    <div class="md:flex m-4">
        <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-600  md:me-4 mb-4 md:mb-0">
            <li>
                <a href="interventions_intervenant.php" id="interventions" class="category gap-1 inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-100 hover:bg-gray-200 w-full" aria-current="page">
                    <svg class="w-4 h-4 me-2 text-white text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18"><path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z"/></svg>
                    Interventions
                </a>
            </li>
            <li>
                <a href="historique_intervenant.php" class="gap-1 inline-flex items-center px-4 py-3 text-white bg-cyan-400 hover:bg-cyan-800 active rounded-lg w-full">
        ...
        <form class="max-w-md mx-auto" action="recherchehisto_intervenant.php" method="post">   
                            ...
                            <div class='bg-cyan-300 rounded m-4 p-4'>
                                <div class='flex p-4 justify-between font-bold items-start text-medium'>
                                    ...
                                    <div class='flex gap-5 items-center'>
                                        ...
                                        <form action='State_managing.php' method='post' class='flex gap-1 items-center'>
