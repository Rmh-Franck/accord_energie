    ...
    <div class="md:flex m-4">
        ...
        <div id="interventionDisplay" class="flex-col p-2 bg-gray-200 text-medium text-gray-700 rounded-lg w-full">
            <div class="flex justify-between items-center">
                <form class="w-full max-w-md mx-auto" action="rechercheclient_standardiste.php" method="post">
        ...
        <?php
            ...
            $sql = "SELECT u.*
            FROM users u
            AND u.nom LIKE '%$titre_recherche%' OR u.id='$titre_recherche' OR u.prenom LIKE '%$titre_recherche%'
            ";
                        ...
                        echo "
                            <div class='bg-cyan-300 rounded m-4 p-4'>
                                <div class='flex p-4 justify-between font-bold items-start text-medium'>
                                    ...
                                    <form action='role_managing.php' method='post' class='flex gap-1 item-center'>
