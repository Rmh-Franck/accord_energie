...
<body>
    ...
    <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-600  md:me-4 mb-4 md:mb-0">
            ...
            <li>
                <a href="utilisateurs_admin.php" class="gap-1 inline-flex items-center px-4 py-3 text-white bg-cyan-400 hover:bg-cyan-800 active rounded-lg w-full">
                            ...
                            <div class='bg-cyan-300 rounded m-4 p-4'>
                                <div class='flex p-4 justify-between font-bold items-start text-medium'>
                                    ...
                                    <form action='role_managing.php' method='post' class='flex gap-1 item-center'>
                                            <select class='border border-gray-400 p-2 rounded w-full' name='role' id='role'>
